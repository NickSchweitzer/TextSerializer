...
| class [IniField](TheCodingMonkey.Serialization/IniField.md) | Contains configuration properties for a field/property that are specific to INI files |
| class [IniFieldAttribute](TheCodingMonkey.Serialization/IniFieldAttribute.md) | This attribute is applied to Fields or Properties of a class to control how an INI field is handled. |
| enum [IniLineType](TheCodingMonkey.Serialization/IniLineType.md) | Enumeration which defines the different types of items that can be in an INI file for parsing purposes |
| class [IniSection](TheCodingMonkey.Serialization/IniSection.md) | Contains configuration properties for a class/struct that represents a section in an INI file |
| class [IniSectionAttribute](TheCodingMonkey.Serialization/IniSectionAttribute.md) | This attribute is applied to Fields, Properties, or the class/struct definition itself to control how an INI Section is declared. |
| class [IniSerializer&lt;TTargetType&gt;](TheCodingMonkey.Serialization/IniSerializer-1.md) | Used to serialize a TargetType object to an INI file. |
...
| abstract class [RecordSerializer&lt;TTargetType&gt;](TheCodingMonkey.Serialization/RecordSerializer-1.md) | Base class that contains common code for the [`CsvSerializer`](TheCodingMonkey.Serialization/CsvSerializer-1.md) and [`FixedWidthSerializer`](TheCodingMonkey.Serialization/FixedWidthSerializer-1.md) class. |
...
| class [IniConfiguration&lt;TTargetType&gt;](TheCodingMonkey.Serialization.Configuration/IniConfiguration-1.md) | Fluent Configuration class for the [`IniSerializer`](TheCodingMonkey.Serialization/IniSerializer-1.md) class. |
| abstract class [RecordConfiguration&lt;TTargetType&gt;](TheCodingMonkey.Serialization.Configuration/RecordConfiguration-1.md) | Base class for Fluent Configuration classes |
...
| public type | description |
| --- | --- |
| static class [ParsingHelper](TheCodingMonkey.Serialization.Utilities/ParsingHelper.md) | Helper class which contains some common code for parsing CSV and Ini Files |
