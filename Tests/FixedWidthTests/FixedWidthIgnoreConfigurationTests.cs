...
namespace TheCodingMonkey.Serialization.Tests
{
    ...
    public class FixedWidthIgnoreConfigurationTests : CsvIgnoreConfigurationTests
    {
        public FixedWidthIgnoreConfigurationTests()
        {
            DeserializeTestFile = "FixedWidthWithOptionsFile.txt";
            SerializeTestFile = "FixedWidthFile.txt";
            Serializer = new FixedWidthSerializer<PocoWithExtraFieldsRecord>(config => config
